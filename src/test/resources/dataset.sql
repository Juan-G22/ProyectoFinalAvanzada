INSERT INTO Cuenta (codigo, email,estado, password, tipo ) VALUES (1, 'pepito@email.com',true, 'Admin123', 'Administrador');
INSERT INTO Cuenta (codigo, email,estado, password, tipo ) VALUES (2, 'juanita@email.com',true, 'Admin95', 'Administrador');
INSERT INTO Cuenta (codigo, email,estado, password, tipo) VALUES (3, 'luisalopez@gmail.com',true, 'luisa2023', 'Paciente' );
INSERT INTO Cuenta (codigo, email,estado, password, tipo) VALUES (4 ,'pedrogonzalez@gmail.com',true, 'pedro2025', 'Paciente');
INSERT INTO Cuenta (codigo, email,estado, password, tipo) VALUES (5, 'mariaperez@gmail.com',true, 'maria20', 'Paciente');
INSERT INTO Cuenta (codigo, email,estado, password, tipo) VALUES (6, 'carlosrodriguez@gmail.com',true, 'carro20', 'Paciente');
INSERT INTO Cuenta (codigo, email,estado, password, tipo ) VALUES (7, 'lauragonzalez@gmail.com',true, 'lalala21', 'Paciente');
INSERT INTO Cuenta (codigo, email,estado, password, tipo) VALUES (8, 'juanfigueroa@clinicajpm.com',true, 'figueroa23', 'Medico');
INSERT INTO Cuenta (codigo, email,estado, password, tipo) VALUES (9, 'carlosruiz@clinicajpm.com',true, 'caruiz95', 'Medico');
INSERT INTO Cuenta (codigo, email,estado, password, tipo )VALUES (10, 'ganudi@clinicajpm.com',true, 'ganudi30', 'Medico');
INSERT INTO Cuenta (codigo, email,estado, password, tipo) VALUES (11, 'andresramirez@clinicajpm.com',true, 'andrre10', 'Medico');
INSERT INTO Cuenta (codigo, email,estado, password, tipo)VALUES (12, 'monicavargas@clinicajpm.com',true, 'mysecretpw', 'Medico');
...
insert into pqrs (codigo, estadopqrs,fecha_creacion,motivo,tipopqrs,cita_codigo)
values (3,1,  '2023-02-10', 'El doctor en la cita no me permitió hablar',1,3);
insert into pqrs (codigo, estadopqrs,fecha_creacion,motivo,tipopqrs,cita_codigo)
